const createChapterTableQuery = '''CREATE TABLE IF NOT EXISTS chapters(
...
const createNovelIdIndexQuery =
    '''CREATE INDEX IF NOT EXISTS chapterNovelIdIndex ON chapters(novelId)''';

const createUnreadChaptersIndexQuery =
    '''CREATE INDEX IF NOT EXISTS chapterUnreadByNovelIndex ON chapters(novelId, \'read\') WHERE \'read\'=0''';
